...
if attack_table.empty:
    attack_table = pd.DataFrame(columns=[
        "hipotese_ataque",
        "familia",
        "score_final",
        "voto_modelo_focado",
        "voto_modelo_detalhado",
        "prob_media_modelo_detalhado",
        "prob_media_macroclasse",
    ])
else:
    attack_table = attack_table.sort_values("score_final", ascending=False)
