...
DATASET = Path("cicflowmeter/processed_csv_v2/dataset_rodadas_01_05.csv")
FEATURES_FILE = Path("cicflowmeter/processed_csv_v2/feature_columns_no_ports_v2.txt")
OUT_DIR = Path("results/modelo_v2_groupcv")
