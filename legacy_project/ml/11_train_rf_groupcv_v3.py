...
DATASET = Path("cicflowmeter/processed_csv_v3/dataset_rodadas_01_08_c2reforco.csv")
FEATURES_FILE = Path("cicflowmeter/processed_csv_v3/feature_columns_no_ports_v3.txt")
OUT_DIR = Path("results/modelo_v3_groupcv")
